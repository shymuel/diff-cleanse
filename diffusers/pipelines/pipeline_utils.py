...
class ImagePipelineOutput(BaseOutput):
    ...
    activations: Union[List[List[PIL.Image.Image]], np.ndarray] = None
    ...
    def save_pretrained(
        ...
        **kwargs,
        ...
        for pipeline_component_name in model_index_dict.keys():
            print("component name: ", pipeline_component_name)
            ...
            print("save accept_safe: ", save_method_accept_safe)
            print("save accept_variant: ", save_method_accept_variant)
            ...
            # print("safe: ", safe_serialization, variant)  # 这个默认是true没问题
            # print("save kwargs: ", save_kwargs["safe_serialization"])
