...
try:
    ...
    _import_structure["ddpm"] = ["DDPMPipeline", "DDPMPipeline_ACT", "DDPMPipeline_PRUNE"]
    ...
    _import_structure["pndm"] = ["PNDMPipeline", "PNDMPipeline_ACT", "PNDMPipeline_PRUNE"]
...
if TYPE_CHECKING:
    try:
        ...
        from .ddpm import DDPMPipeline, DDPMPipeline_ACT, DDPMPipeline_PRUNE
        from .dit import DiTPipeline
        from .latent_diffusion import LDMSuperResolutionPipeline
        from .latent_diffusion_uncond import LDMPipeline
        from .pipeline_utils import AudioPipelineOutput, DiffusionPipeline, ImagePipelineOutput
        from .pndm import PNDMPipeline, PNDMPipeline_ACT, PNDMPipeline_PRUNE
