...
class DatasetLoader(object):
    ...
    def __load_dataset(self, name: str):
        ...
        if name == DatasetLoader.MNIST:
            ...
            return load_dataset("D:\\00_dataset\\cifar10", split=split_method)  # 这个方法会读取cifar10数据集，并缓存到c盘一个文件夹下
            # return load_dataset("cifar10", split=split_method)
        elif name == DatasetLoader.CIFAR10_SYN:
            return load_dataset("D:\\00_dataset\\cifar10_syn", data_dir="D:\\00_dataset\\cifar10_syn", split="train")
            ...
            # return load_dataset("D:\\00_dataset\\celebahq256")
            return load_dataset("D:\\00_dataset\\celebahq-1024", split="train+validation")
        ...
        #     return load_from_disk("datasets/celeba_hq_256_pr05")
            ...
            return LatentDataset(ds_root="G:\\celeba_hq_256_latents")
        elif name == DatasetLoader.CELEBA_HQ_LATENT_SYN:
    ...
    def __transform_generator(self, dataset_name: str, clean: bool, R_trigger_only: bool) -> Callable[
        ...
        def backdoor_transforms(examples) -> DatasetDict:
            ...
            examples[DatasetLoader.PIXEL_VALUES_TRIGGER] = self.__trigger.repeat(*repeat_times)  # 只把trigger复制
            if R_trigger_only:
                ...
                examples[DatasetLoader.PIXEL_VALUES] = masks * examples[DatasetLoader.IMAGE] + (
                            1 - masks) * self.__trigger.repeat(*repeat_times)  # trigger和原图叠加
